...
export const fetchAllJobs = () => {
    return async (dispatch, getState) => {
        ...
        try {
            const response = await fetch(`https://myjobsapp-c2013.firebaseio.com/allJobs.json`)
...
export const deleteJob = (jobId) => {
    return async (dispatch) => {
        ...
        await fetch(`https://myjobsapp-c2013.firebaseio.com/allJobs/${jobId}.json?auth=${token}`, {
            method: 'DELETE'
        })
...
export const updateJob = (jobId, data) => {
    return async (dispatch) => {
        ...
        try {
            ...
            const response = await fetch(`https://myjobsapp-c2013.firebaseio.com/allJobs/${jobId}.json?auth=${token}`, {
                method: 'PATCH',
                headers: {
                    "Content-Type": "application/json"
                },
